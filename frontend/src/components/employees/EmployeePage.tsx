  ...
  return (
    <div className="h-full overflow-y-auto p-5" style={{ background: "#EDECEA" }}>
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2 px-3 py-2 bg-white rounded-full shadow-[0_1px_3px_rgba(0,0,0,0.08)] text-xs text-gray-400">
          ...
          <input
            ...
            className="bg-transparent outline-none w-44 text-gray-700 placeholder-gray-400"
          />
        </div>
      </div>
        ...
        <div className="p-5">
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[1,2,3,4,5,6].map(i => <div key={i} className="h-20 rounded-xl bg-gray-50 animate-pulse" />)}
            </div>
          ) : employees.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {employees.map((emp, idx) => {
                ...
                return (
                  <div
                    key={emp.id}
                    className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100 cursor-pointer group"
                  >
                    <div
